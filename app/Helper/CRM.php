...
class CRM
{
    ...
    public static $scopes = 'contacts.readonly locations.readonly locations/tags.readonly payments/orders.readonly payments/orders.write payments/subscriptions.readonly payments/transactions.readonly payments/custom-provider.readonly payments/custom-provider.write invoices.readonly';
    ...
    public static function saveClickupToken($code, $company_id)
    {
        ClickupAuths::updateOrCreate(
            ['user_id' => $company_id], 
            ['access_token' => $code]
        );
    }
